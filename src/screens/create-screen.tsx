    ...
    return (
        <div className="screen create-screen">
            ...
            <newContext.Provider value={context}>
                <Input callback={setTitle} placeholder="Название теста" defaultValue={title} />
                <CreateList />
                <Button title="Добавить вопрос" outline callback={onNewQuestion} />
                <Button title="Закончить создание теста" callback={onQuizDone} />
            </newContext.Provider>
        </div>
    )
